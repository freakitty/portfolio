...
/* ======================================= KEYDOWN =============================== */
    var show = ['Hello', 'there', '!', '<br>', "I am", '<a href="images/CV.pdf" target="_blank" style="color:#40ffbf">Cindy</a>', 'Castano,', '<br>', 'a', "graphic", '&', "web", "designer", 'based', 'in', 'Paris.', "I'm", 'passionate', 'about', 'print,', "design,", 'and', 'digital.', 'I', 'like', 'to', "mix", 'both', 'to', 'create', 'solutions', 'that', 'add', 'value.', '<br>', "Let's", 'get', 'in', 'touch', 'for', 'any', 'project', 'inquiries', '<br>', '>> just', 'drop', 'me a', '<a href="mailto:castano.cindy1@gmail.com" style="color:#40ffbf"> line</a>', '.'], i = 0, updateHey = function () {
        if (i < show.length) {
